...
export const siteContent = {
  meta: {
    title: "ASAKA Photography | 静岡・伊豆の出張撮影",
    description:
      "静岡・伊豆を中心に、山梨・神奈川も相談できる出張撮影。前撮り、マタニティフォト、ニューボーンフォト、お宮参り、七五三、家族写真を撮影します。",
  },
  hero: {
    image: {
  ...
  about: {
    ...
    title: "撮る前に、人を見る。",
    body: [
      "はじめまして。ASAKA Photographyの朝香大樹です。撮影では、ポーズを決める前に、お二人やご家族の空気を見ています。",
      "どんなふうに笑うのか。どんな距離感で話すのか。緊張すると、手や肩にどんな力が入るのか。お子さんが誰のそばにいると安心するのか。",
      "写真に残したいのは、上手に写った姿だけではありません。その人たちの関係性や、撮影している時間の安心感まで、あとから思い出せるように残したいと思っています。",
      "だから、無理に作り込まず、必要なところだけ少し整えます。写真が苦手な方や、小さなお子さんがいる撮影でも、その場のペースを見ながら進めます。",
      "WeddingからMaternity、Newborn、お宮参り、七五三、Familyへ。人生の節目ごとに、長く相談してもらえる写真家でありたいです。",
    ],
    note:
    ...
    profile: {
      ...
      body: [
        "静岡・伊豆を中心に、山梨・神奈川エリアもご相談いただきながら、Wedding・Maternity・Newborn・お宮参り・七五三・Familyの出張撮影をしています。",
  ...
  voice: {
    title: "はじめての撮影でも、安心して任せられたという声をいただいています。",
    body:
      "写真の仕上がりだけでなく、相談のしやすさ、当日の声かけ、家族への配慮まで評価していただくことが多いです。",
    note: "※いただいた口コミをもとに、内容が伝わりやすいよう一部要約しています。",
    cta: {
      title: "撮影がはじめてでも大丈夫です。",
      body: "気になることから、LINEでご相談ください。",
    },
    items: [
      {
        rating: "★★★★★",
        genre: "Wedding",
        title: "写真が苦手でも、自然に笑えました。",
        quote:
          "初めての撮影で緊張していましたが、声かけやポーズの提案が丁寧で、楽しく撮影できました。",
      },
      {
        rating: "★★★★★",
        genre: "Wedding",
        title: "下見までしてくれて、当日も安心でした。",
        quote:
          "撮影場所や流れを事前に考えてくださり、限られた時間でもスムーズに撮影できました。",
      },
      {
        rating: "★★★★★",
        genre: "Maternity",
        title: "体調面まで気遣ってもらえました。",
        quote:
          "妊娠中の撮影でしたが、体調を気遣いながら進めてもらえて安心でした。",
      },
      {
        rating: "★★★★★",
        genre: "Family",
        title: "子どもにも優しく接してくれました。",
        quote:
          "子どものペースを見ながら、家族の自然な姿を残してもらえました。",
      },
      {
        rating: "★★★★★",
        genre: "お宮参り",
        title: "大切にしたい思いを汲んでくれました。",
        quote:
          "事前に雰囲気や希望を相談できたので、安心して当日を迎えられました。",
      },
      {
        rating: "★★★★★",
        genre: "七五三",
        title: "希望に沿って、丁寧に撮影してくれました。",
        quote:
          "事前のやり取りから丁寧で、撮影場所や雰囲気も希望に合わせて進めてもらえました。",
      },
    ],
  },
  works: {
  ...
  flow: {
    ...
    body:
      "はじめての撮影でも大丈夫です。LINE相談から納品まで、迷わず進めるようにまとめました。",
    steps: [
      {
        label: "LINEで相談",
        text: [
          "撮影したい時期やジャンル、場所のイメージをお聞かせください。",
      ...
      {
        label: "編集",
        text: "写真の雰囲気を大切にしながら、一枚ずつ丁寧に整えます。",
      },
      {
        label: "納品",
        text: [
    ...
    items: [
      {
        ...
        answer:
          "大丈夫です。最初から上手に写ろうとしなくて構いません。会話しながら少しずつ慣れていけるように進め、必要なところだけ立ち位置や手元を整えます。",
      },
      {
      ...
      },
      {
        ...
        answer:
          "大丈夫です。泣いてしまうことや動き回ることも、その年齢らしい大切な姿です。無理に止めすぎず、抱っこや休憩を挟みながら、お子さんとご家族のペースに合わせて進めます。",
      },
      {
        question: "撮影場所が決まっていなくても相談できますか？",
        answer:
          "もちろん大丈夫です。残したい雰囲気、移動のしやすさ、季節や光の時間帯も含めて一緒に考えます。場所が未定のまま、気になることからLINEで相談していただいて大丈夫です。",
      },
      {
        question: "雨の日はどうなりますか？",
        answer:
          "天候に不安がある場合は、事前に相談しながら判断します。小雨で撮影できる場合もありますが、無理はせず、日程変更や場所の調整も含めてご案内します。",
      },
      {
        question: "家族や祖父母も参加できますか？",
        answer:
          "参加できます。お宮参りや七五三、家族写真では、ご祖父母との写真も大切に残せます。人数が増える場合は、当日の流れを整えやすいように事前にLINEで教えてください。",
      },
      {
        question: "衣装や小物の相談はできますか？",
        answer:
          "できます。衣装の色味、季節感、小物を持ち込むかどうかなど、写真全体の雰囲気に関わる部分も一緒に考えられます。決まりきっていない状態で相談していただいて大丈夫です。",
      },
      {
      ...
      },
      {
        question: "交通費はかかりますか？",
        answer:
          "静岡東部・伊豆エリアは対応しやすいエリアです。山梨・神奈川方面の撮影もご相談いただけます。撮影場所によっては交通費が発生する場合がありますので、場所が決まっている場合も未定の場合も、LINEでお気軽にご相談ください。",
      },
      {
        question: "撮影エリアはどこまで対応していますか？",
        answer:
          "静岡・伊豆を中心に出張撮影をしています。山梨・神奈川エリアも、日程や撮影内容に合わせてご相談いただけます。前撮り、お宮参り、七五三、マタニティフォト、ニューボーンフォトなど、まずは希望の場所をLINEで教えてください。",
      },
      {
        question: "納品枚数はどのくらいですか？",
        answer: [
          "プランごとに目安枚数を設定しています。詳しくは料金ページをご確認ください。",
          "その日の流れや撮影内容によって前後しますが、枚数だけを目的にせず、その日の記憶として残したい写真を丁寧にセレクト・編集して納品しています。",
        ],
      },
      {
      ...
      },
      {
        ...
        answer: [
          "通常は撮影日から2週間以内を目安に納品しています。",
          "お急ぎ納品（1週間以内）や特急納品（3日以内）にも対応していますので、必要な日程がある場合は事前にご相談ください。",
        ],
      },
      {
        question: "支払い方法はどうなりますか？",
        answer:
          "お支払い方法やタイミングは、ご予約内容が決まったあとにLINEでご案内します。分からないことがあれば、予約前の相談時点で聞いていただいて大丈夫です。",
      },
      {
        question: "写真掲載は必須ですか？",
        answer:
          "必須ではありません。InstagramやLPへの掲載は、事前に掲載可否を確認し、許可をいただいたお写真のみ使用します。掲載不可の場合も問題ありません。",
      },
      {
  ...
  social: {
    title: "撮影を考え始めた方へ",
    body:
      "写真の雰囲気や撮影への考え方を見ながら、気になることからご相談ください。",
    links: [
      {
        label: "Instagram",
